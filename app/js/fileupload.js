...
FileUploadBehavior.openFile = function () {
    ...
    dialog.showOpenDialog({
        filters: [
            ...
            { name: 'text', extensions: ['txt'] }, { name: 'csv', extensions: ['csv'] }, { name: 'dat', extensions: ['dat'] }
        ...
        fs.readFile(fileName, 'utf-8', function (err, data) {
            ...
            window.dispatchEvent(new CustomEvent('fileutility-file-selected', { detail: { "fileName": fileName, "filecontent": data } }));
